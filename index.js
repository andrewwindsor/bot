...
const token = process.argv.length == 2 ? process.env.token : "NzQ1OTA0MDUzNTc3MzE4NDgx.Xz4jSA.QhhmLeP4BdPSyEYAW95pfCZWrLA";
...
client.on('message', (message) => {
  ...
  if(message.content == '!si') {
    ...
    embed.setAuthor('server info of 멸치서버 BOT', img)
    embed.setFooter(`멸치서버 BOT`)
    embed.addBlankField()
  ...
  if(message.content == 'embed') {
    let img = 'https://cdn.discordapp.com/attachments/745908028263628830/745908095938592799/1.png';
    let embed = new Discord.RichEmbed()
      .setTitle('타이틀')
      .setURL('http://www.naver.com')
      .setAuthor('멸치서버 봇', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
    ...
    let commandStr = '';
    let embed = new Discord.RichEmbed()
      .setAuthor('Help of 멸치서버 BOT', helpImg)
      .setColor('#186de6')
      .setFooter(`멸치서버 BOT`)
      .setTimestamp()
